...
if __name__ == "__main__":
    ...
    parser.add_argument('--skip_plot',default=10,type=int, help= 'the interval to calculate')
    ...
    parser.add_argument('--random', default=0,type=int,help='whether use random data augmentation')
