...
# Plotting the data
plt.scatter(x[0], y[0], label='No Augmented', color='blue', marker='o')
plt.scatter(x[1], y[1], label='Augmented', color='orange', marker='d')
