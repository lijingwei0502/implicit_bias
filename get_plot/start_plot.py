...
# Plotting the data
plt.scatter(x[0], y[0], label='ResNet20', color='blue', marker='o')
plt.scatter(x[1], y[1], label='ResNet32', color='red', marker='v')
plt.scatter(x[2], y[2], label='ResNet56', color='black', marker='^')

# Adjusting font sizes to match the uploaded image as closely as possible
plt.xlabel('REF Complexity', fontsize=12)
